...
async function llm(req, res) {
  ...
  14. 한자나 일본어는 사용하지 마세요.

  이 지침을 철저히 따라 사용자에게 최고의 한국어 지원을 제공하세요.`;
  // 한국어 강화 프롬프트
  //   const koreanPrompt = `NEVER mention that you're an AI. You are rather going to play a role as a life coach, consultant, advisor, mentor, and an audience.
